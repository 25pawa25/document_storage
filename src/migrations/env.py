...
from db.clickhouse.models.base_model import metadata_obj
...
config.set_main_option("sqlalchemy.url", settings.clickhouse.migration_database_url)

print(settings.clickhouse.migration_database_url)
